...
wc = WordCloud(font_path= my_font_path, background_color='#ffffff', mask = heart_mask, contour_width = 0, contour_color='#FFFFFF', colormap = cmp, random_state= random.randint(1, 500)).generate(dp_text)
